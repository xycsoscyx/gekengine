    ...
    namespace Render::Implementation
    {
            ...
            , public Render::Debug::Device
        {
            ...
            public:
                ...
                void bindIndexBuffer(Render::Resource* indexBuffer, uint32_t offset)
                {
                    ...
                    if (internalBuffer)
                    {
                        DXGI_FORMAT format = Render::Implementation::BufferFormatList[static_cast<uint8_t>(internalBuffer->description.format)];
        ...
        public:
            ...
            CComPtr<ID3D11RasterizerState> createRasterizerState(const Render::PipelineState::RasterizerState::Description &rasterizerStateDescription)
            {
                ...
                rasterizerDescription.FillMode = Render::Implementation::FillModeList[static_cast<uint8_t>(rasterizerStateDescription.fillMode)];
                rasterizerDescription.CullMode = Render::Implementation::CullModeList[static_cast<uint8_t>(rasterizerStateDescription.cullMode)];
            ...
            CComPtr<ID3D11DepthStencilState> createDepthState(const Render::PipelineState::DepthState::Description &depthStateDescription)
            {
                ...
                depthStencilDescription.DepthFunc = Render::Implementation::ComparisonFunctionList[static_cast<uint8_t>(depthStateDescription.comparisonFunction)];
                ...
                depthStencilDescription.FrontFace.StencilFailOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilFrontState.failOperation)];
                depthStencilDescription.FrontFace.StencilDepthFailOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilFrontState.depthFailOperation)];
                depthStencilDescription.FrontFace.StencilPassOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilFrontState.passOperation)];
                depthStencilDescription.FrontFace.StencilFunc = Render::Implementation::ComparisonFunctionList[static_cast<uint8_t>(depthStateDescription.stencilFrontState.comparisonFunction)];
                depthStencilDescription.BackFace.StencilFailOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilBackState.failOperation)];
                depthStencilDescription.BackFace.StencilDepthFailOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilBackState.depthFailOperation)];
                depthStencilDescription.BackFace.StencilPassOp = Render::Implementation::StencilOperationList[static_cast<uint8_t>(depthStateDescription.stencilBackState.passOperation)];
                depthStencilDescription.BackFace.StencilFunc = Render::Implementation::ComparisonFunctionList[static_cast<uint8_t>(depthStateDescription.stencilBackState.comparisonFunction)];
                depthStencilDescription.DepthWriteMask = Render::Implementation::DepthWriteMaskList[static_cast<uint8_t>(depthStateDescription.writeMask)];
            ...
            CComPtr<ID3D11BlendState> createBlendState(const Render::PipelineState::BlendState::Description &blendStateDescription)
            {
                ...
                for (uint32_t renderTarget = 0; renderTarget < 8; ++renderTarget)
                {
                    ...
                    blendDescription.RenderTarget[renderTarget].SrcBlend = Render::Implementation::BlendSourceList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].colorSource)];
                    blendDescription.RenderTarget[renderTarget].DestBlend = Render::Implementation::BlendSourceList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].colorDestination)];
                    blendDescription.RenderTarget[renderTarget].BlendOp = Render::Implementation::BlendOperationList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].colorOperation)];
                    blendDescription.RenderTarget[renderTarget].SrcBlendAlpha = Render::Implementation::BlendSourceList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].alphaSource)];
                    blendDescription.RenderTarget[renderTarget].DestBlendAlpha = Render::Implementation::BlendSourceList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].alphaDestination)];
                    blendDescription.RenderTarget[renderTarget].BlendOpAlpha = Render::Implementation::BlendOperationList[static_cast<uint8_t>(blendStateDescription.targetStateList[renderTarget].alphaOperation)];
            ...
            std::vector<D3D11_INPUT_ELEMENT_DESC> getVertexDeclaration(const std::vector<Render::PipelineState::VertexDeclaration> &vertexDeclaration)
            {
                ...
                for (auto const &vertexElement : vertexDeclaration)
                {
                    ...
                    elementDescription.Format = Render::Implementation::BufferFormatList[static_cast<uint8_t>(vertexElement.format)];
                    ...
                    elementDescription.SemanticName = Render::Implementation::VertexSemanticList[static_cast<uint8_t>(vertexElement.semantic)].data();
            ...
            std::string getShaderHeader(const Render::PipelineState::Description &pipelineStateDescription)
            {
                ...
                {
                    std::string semantic = Render::Implementation::VertexSemanticList[static_cast<uint8_t>(vertexElement.semantic)].data();
                    std::string format = Render::Implementation::getFormatSemantic(vertexElement.format);
                ...
                {
                    std::string semantic = Render::Implementation::PixelSemanticList[static_cast<uint8_t>(pixelElement.semantic)].data();
                    std::string format = Render::Implementation::getFormatSemantic(pixelElement.format);
                ...
                {
                    std::string format = Render::Implementation::getFormatSemantic(renderTarget.format);
...
{{
    {}
                ...
                if (dxgiOutput)
                {
                    ...
                    for (auto const &dxgiDisplayMode : dxgiDisplayModeList)
                    {
                        if (dxgiDisplayMode.ScanlineOrdering == DXGI_MODE_SCANLINE_ORDER_PROGRESSIVE && dxgiDisplayMode.Scaling == DXGI_MODE_SCALING_CENTERED)
                        {
                            ...
                            displayMode.format = Render::Implementation::GetFormat(dxgiDisplayMode.Format);
            ...
            Render::PipelineStatePtr createPipelineState(Render::PipelineFormat* pipelineFormat, const Render::PipelineState::Description &pipelineStateDescription)
            {
                ...
                auto primitiveTopology = Render::Implementation::TopologList[static_cast<uint8_t>(pipelineStateDescription.primitiveType)];
            ...
            Render::SamplerStatePtr createSamplerState(Render::PipelineFormat* pipelineFormat, const Render::SamplerState::Description &samplerStateDescription)
            {
                ...
                samplerDescription.AddressU = Render::Implementation::AddressModeList[static_cast<uint8_t>(samplerStateDescription.addressModeU)];
                samplerDescription.AddressV = Render::Implementation::AddressModeList[static_cast<uint8_t>(samplerStateDescription.addressModeV)];
                samplerDescription.AddressW = Render::Implementation::AddressModeList[static_cast<uint8_t>(samplerStateDescription.addressModeW)];
                ...
                samplerDescription.ComparisonFunc = Render::Implementation::ComparisonFunctionList[static_cast<uint8_t>(samplerStateDescription.comparisonFunction)];
                ...
                samplerDescription.Filter = Render::Implementation::FilterList[static_cast<uint8_t>(samplerStateDescription.filterMode)];
            ...
            void copyResource(Render::Resource* destination, Render::Resource* source)
            {
                ...
                auto destinationTexture = dynamic_cast<Texture*>(destination);
                auto sourceTexture = dynamic_cast<Texture*>(source);
                if (destinationTexture && sourceTexture)
                {
                    ...
                    {
                        d3dDefaultContext->CopySubresourceRegion(destinationTexture->d3dBaseResource, 0, 0, 0, 0, sourceTexture->d3dBaseResource, 0, nullptr);
                    }
                    else
                    {
                        d3dDefaultContext->CopyResource(destinationTexture->d3dBaseResource, sourceTexture->d3dBaseResource);
                    }
                }
            }
            ...
            Render::TexturePtr createTexture(const Render::Texture::Description &description, const void *data)
            {
                ...
                return std::make_unique<UnorderedTexture>(finalDescription, d3dResource, d3dShaderResourceView, d3dUnorderedAccessView);
            }

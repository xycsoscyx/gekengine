...
namespace Gek
{
    ...
    public:
        ...
        void onQueueDrawCalls(Shapes::Frustum const &viewFrustum, Math::Float4x4 const &viewMatrix, Math::Float4x4 const &projectionMatrix)
        {
			...
			GEK_PROFILER_BEGIN_SCOPE(getContext(), "Models Update"sv)
			{
				...
				GEK_PROFILER_BEGIN_SCOPE(getContext(), "Collect Entities"sv)
				{
				...
				GEK_PROFILER_BEGIN_SCOPE(getContext(), "Cull Entities"sv)
				{
				...
				GEK_PROFILER_BEGIN_SCOPE(getContext(), "Collect Models"sv)
				{
				...
				GEK_PROFILER_BEGIN_SCOPE(getContext(), "Cull Models"sv)
				{
				...
				GEK_PROFILER_BEGIN_SCOPE(getContext(), "Queue Models"sv)
				{

...
float4 mainPixelProgram(in Input input) : SV_TARGET0
{
	return inputBuffer.SampleLevel(inputSampler, input.texCoord, 0.0f);
                ...
                deferredVertexProgram = resources->getProgram(Render::Program::Type::Vertex, "renderer:deferredVertexProgram:v14", "mainVertexProgram", vertexProgram);

                deferredPixelProgram = resources->getProgram(Render::Program::Type::Pixel, "renderer:deferredPixelProgram:v14", "mainPixelProgram", pixelProgram);

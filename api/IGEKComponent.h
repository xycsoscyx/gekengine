...
DECLARE_INTERFACE_IID_(IGEKComponent, IUnknown, "F1CA9EEC-0F09-45DA-BF24-0C70F5F96E3E")
{
    ...
    STDMETHOD(OnEntityDestroyed)            (THIS) { return S_OK; }
    STDMETHOD(OnEvent)                      (THIS_ LPCWSTR pAction, const GEKVALUE &kParamA = GEKVALUE(), const GEKVALUE &kParamB = GEKVALUE()) { return S_OK; }
};

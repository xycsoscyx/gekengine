...
namespace jsoncons
{
    ...
    template<class Json>
    struct json_type_traits<Json, Gek::Math::SIMD::Quaternion>
    {
        static Gek::Math::SIMD::Quaternion as(const Json &object)
        {
            if (object.is_string())
            {
        ...
        static Json to_json(const Gek::Math::SIMD::Quaternion &value)
        {
            return Gek::String::create(L"%v", value);
        }
    };

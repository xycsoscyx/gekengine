...
DECLARE_INTERFACE_IID_(IGEKContext, IUnknown, "E1BBAFAB-1DD8-42E4-A031-46E22835EF1E")
{
    ...
    STDMETHOD_(void, AdjustMetric)                  (THIS_ LPCWSTR pSystem, LPCWSTR pName, INT32 nCount = 1) PURE;
    STDMETHOD_(void, ListSystems)                   (THIS_ std::function<void(LPCWSTR)> OnSystem) PURE;
    STDMETHOD_(void, ListMetrics)                   (THIS_ LPCWSTR pSystem, std::function<void(LPCWSTR, UINT32)> OnMetric) PURE;
};

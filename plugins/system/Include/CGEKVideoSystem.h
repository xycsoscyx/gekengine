...
public:
    ...
    // IGEK3DVideoContext
    STDMETHOD_(System *, GetComputeSystem)             (THIS);
    STDMETHOD_(System *, GetVertexSystem)              (THIS);
    STDMETHOD_(System *, GetGeometrySystem)            (THIS);
    STDMETHOD_(System *, GetPixelSystem)               (THIS);
...
private:
    ...
    concurrency::concurrent_unordered_map<GEKHANDLE, CComPtr<IUnknown>> m_aResources;

private:
    IUnknown *GetResource(const GEKHANDLE &nResourceID)
    {
    ...
    HRESULT GetDefaultTargets(const GEK3DVIDEO::DATA::FORMAT &nDepthFormat);
...
public:
    ...
    // IGEK3DVideoSystem
    STDMETHOD(Initialize)                              (THIS_ HWND hWindow, bool bWindowed, UINT32 nXSize, UINT32 nYSize, const GEK3DVIDEO::DATA::FORMAT &nDepthFormat = GEK3DVIDEO::DATA::UNKNOWN);
    STDMETHOD(Resize)                                  (THIS_ bool bWindowed, UINT32 nXSize, UINT32 nYSize, const GEK3DVIDEO::DATA::FORMAT &nDepthFormat = GEK3DVIDEO::DATA::UNKNOWN);

    ...
    namespace DirectInput8
    {
        ...
        private:
            ...
            void addJoystick(LPCDIDEVICEINSTANCE deviceObjectInstance)
            {
                try
                {
                    Input::DevicePtr joystick(makeShared<Input::Device, Joystick>(directInput, window, deviceObjectInstance->guidInstance));
        ...
        public:
                ...
                , window(window)
            {
                ...
                keyboardDevice = makeShared<Input::Device, Keyboard>(directInput, window);
                mouseDevice = makeShared<Input::Device, Mouse>(directInput, window);

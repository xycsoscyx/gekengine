...
namespace Gek
{
    namespace Audio
    {
        ...
        DECLARE_INTERFACE_IID(SampleInterface, "35560CF2-6972-44A3-9489-9CA0A5FE95C9") : virtual public IUnknown
        {
        ...
        DECLARE_INTERFACE_IID(EffectInterface, "19ED8F1F-D117-4D9A-9AC0-7DC229D478D6") : virtual public SampleInterface
        {
            STDMETHOD_(void, setPan)            (THIS_ float pan) PURE;
            STDMETHOD_(void, play)              (THIS_ bool loop) PURE;
        };

        DECLARE_INTERFACE_IID(SoundInterface, "7C3C561D-669B-4559-A1DD-6350AE7A14C0") : virtual public SampleInterface
        {

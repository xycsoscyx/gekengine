...
#include "GEK\System\OverlayInterface.h"
#include <atlbase.h>
#include <atlstr.h>
#include <functional>
...
namespace Gek
{
    namespace Video
    {
        DECLARE_INTERFACE_IID(Class, "6B94910F-0D37-487E-92C3-B7C391108B44");
        ...
        namespace Buffer
        {
            DECLARE_INTERFACE_IID(Interface, "8210EC49-9452-4BA1-A1F2-B17C0416A6B4") : virtual public IUnknown
            {
        ...
        namespace Texture
        {
            DECLARE_INTERFACE_IID(Interface, "D7793714-FE83-49BA-A68F-149246413867") : virtual public IUnknown
            {
        ...
        namespace Context
        {
            ...
            DECLARE_INTERFACE_IID(Interface, "95262C77-0F56-4447-9337-5819E68B372E") : virtual public IUnknown
            {
                STDMETHOD_(System::Interface *, computeSystem)      (THIS) PURE;
                STDMETHOD_(System::Interface *, vertexSystem)       (THIS) PURE;
                ...
                STDMETHOD_(void, setVertexBuffer)                   (THIS_ UINT32 slot, Buffer::Interface *vertexBuffer, UINT32 offset) PURE;
                STDMETHOD_(void, setVertexBufferList)               (THIS_ UINT32 firstSlot, const std::vector<Buffer::Interface *> &vertexBufferList, const std::vector<UINT32> &offsetList) PURE;
                STDMETHOD_(void, setIndexBuffer)                    (THIS_ Buffer::Interface *indexBuffer, UINT32 offset) PURE;
        ...
        {
            STDMETHOD(initialize)                               (THIS_ HWND window, bool fullScreen, Format depthBufferFormat = Format::Invalid) PURE;
            ...
            STDMETHOD(createDeferredContext)                    (THIS_ Context::Interface **returnObject) PURE;

    ...
    namespace Engine
    {
        ...
        namespace Render
        {
            ...
            static LPCSTR getFormatType(Video3D::Format formatType)
            {
                switch (formatType)
                {
                case Video3D::Format::BYTE:     return "uint";
                case Video3D::Format::BYTE2:    return "uint2";
                case Video3D::Format::BYTE4:    return "uint4";
                case Video3D::Format::BGRA:     return "uint4";
                case Video3D::Format::SHORT:    return "uint";
                case Video3D::Format::SHORT2:   return "uint2";
                case Video3D::Format::SHORT4:   return "uint4";
                case Video3D::Format::UINT:     return "uint";
                case Video3D::Format::UINT2:    return "uint2";
                case Video3D::Format::UINT3:    return "uint3";
                case Video3D::Format::UINT4:    return "uint4";
                case Video3D::Format::HALF:     return "float";
                case Video3D::Format::HALF2:    return "float2";
                case Video3D::Format::HALF4:    return "float4";
                case Video3D::Format::FLOAT:    return "float";
                case Video3D::Format::FLOAT2:   return "float2";
                case Video3D::Format::FLOAT3:   return "float3";
                case Video3D::Format::FLOAT4:   return "float4";
                };

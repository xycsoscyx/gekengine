...
namespace Gek
{
    ...
    namespace Engine
    {
            ...
            : virtual public Plugin::Resources
        {
            ...
            virtual ProgramHandle loadComputeProgram(const wchar_t *fileName, const wchar_t *entryFunction, std::function<bool(const wchar_t *, String &)> onInclude = nullptr, const std::unordered_map<String, String> &definesMap = std::unordered_map<String, String>()) = 0;
            virtual ProgramHandle loadPixelProgram(const wchar_t *fileName, const wchar_t *entryFunction, std::function<bool(const wchar_t *, String &)> onInclude = nullptr, const std::unordered_map<String, String> &definesMap = std::unordered_map<String, String>()) = 0;

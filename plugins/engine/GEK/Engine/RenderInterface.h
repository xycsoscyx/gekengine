    ...
    namespace Engine
    {
        namespace Render
        {
            ...
            DECLARE_INTERFACE_IID(Interface, "C851EC91-8B07-4793-B9F5-B15C54E92014") : virtual public IUnknown
            {
                ...
                STDMETHOD(createBuffer)                         (THIS_ Video::Buffer::Interface **returnObject, Video::Format format, UINT32 count, Video::BufferType type, DWORD flags, LPCVOID staticData = nullptr) PURE;

...
DECLARE_INTERFACE_IID_(IGEKInputDevice, IUnknown, "58BF03BB-69A2-45FC-B124-6DA702E949F9")
{
    STDMETHOD(Refresh)                          (THIS) PURE;

    STDMETHOD_(UINT32, GetNumButtons)           (THIS) const PURE;
    STDMETHOD_(UINT32, GetState)                (THIS_ UINT32 nIndex) const PURE;

    STDMETHOD_(float3, GetAxis)                 (THIS) const PURE;
    STDMETHOD_(float3, GetRotation)             (THIS) const PURE;
};

DECLARE_INTERFACE_IID_(IGEKInputSystem, IUnknown, "1F96303C-C8CD-4FE8-944F-C2B1B55747F2")
{
    STDMETHOD_(IGEKInputDevice *, GetKeyboard)  (THIS) PURE;
    STDMETHOD_(IGEKInputDevice *, GetMouse)     (THIS) PURE;
    
    STDMETHOD_(UINT32, GetNumJoysticks)         (THIS) PURE;
    STDMETHOD_(IGEKInputDevice *, GetJoystick)  (THIS_ UINT32 nDevice) PURE;

    STDMETHOD(Refresh)                          (THIS) PURE;
};

SYSTEM_USER(InputSystem, "4CA642E0-0576-40BE-96DA-A0FE12822AF2");
